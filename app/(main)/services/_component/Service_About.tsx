...
const Service_About = ({data}:any) => {
    return (
        <div className='flex flex-col  justify-center items-center min-h-fit max-w-7xl mx-auto gap-20 sm:gap-0'>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-5 sm:gap-40' key={index}>
                ...
                <div className='flex justify-between'>
                    <div className='hidden sm:flex justify-between items-center mx-auto w-full'>
                        ...
                        <Image className='w-60 h-60 lg:w-96 lg:h-96 relative m-10' src={item.image} width={500} height={500} alt='Digital marketing related picture' />
                    </div>
