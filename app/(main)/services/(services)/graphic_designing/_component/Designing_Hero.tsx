        ...
        <div className='flex flex-col sm:flex-row items-center justify-center gap-0 mx-auto max-w-7xl px-5 pt-12'>
                <div className='flex flex-col items-center sm:items-start justify-start gap-5 '>
                    <div className='flex flex-col items-center sm:items-start justify-center'>
                        <h1 className={`text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-black via-cyan-400 to-cyan-600 sm:text-start text-center text-transparent bg-clip-text py-3`}>{title}</h1>
