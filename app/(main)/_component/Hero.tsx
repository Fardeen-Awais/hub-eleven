  ...
  return (
    <section className='flex flex-col md:flex-row justify-start sm:justify-start items-center max-w-7xl mx-auto gap-10 min-h-screen z-10'>
      <div className='flex flex-col sm:flex-row items-center py-5 lg:gap-20'>
        ...
        <div className='flex flex-col items-center px-5 sm:items-start gap-3 w-full'>
          <div className='flex flex-col gap-2'>
            <h1 className={`bg-gradient-to-r from-cyan-400 to-gray-200 text-transparent bg-clip-text font-bold p-3`}>
              <TypeAnimation
                sequence={[
