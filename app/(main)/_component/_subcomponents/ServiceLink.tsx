...
const Link = ({ heading, imgSrc, subheading, href }:any) => {
  ...
  return (
    <motion.a
      ...
      className="group relative flex items-center justify-between border-b-2 border-gray-700 py-4 transition-colors duration-500 hover:border-gray-50 md:py-8 min-w-96"
    >
      <div>
        <motion.span
          variants={{
        ...
        <span className="relative z-10 mt-2 block text-base text-gray-500 transition-colors duration-500 group-hover:text-gray-200">
          {subheading}
        </span>
      </div>
