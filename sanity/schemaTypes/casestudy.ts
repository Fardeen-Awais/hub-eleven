      ...
      of: [
        {
          ...
          options: {
            list: [
              ...
              { title: "Social Media Organic", value: "social_media_organic" },
              { title: "Meta Ads", value: "meta_ads" },
              { title: "Influencer Marketing", value: "influencer_marketing" },
              { title: "Ecommerce Store", value: "ecommerce_store" },
              { title: "Business Sites", value: "business_sites" },
              {
              ...
              { title: "Logo Designing", value: "logo_designing" },
              { title: "UI/UX Design", value: "ui_ux_design" },
              { title: "Flyers and Brochures", value: "flyers_brochures" },
            ],
