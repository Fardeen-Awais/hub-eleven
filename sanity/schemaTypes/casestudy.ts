      ...
      of: [
        {
          ...
          options: {
            list: [
              { title: 'Service A', value: 'serviceA' },
              { title: 'Service B', value: 'serviceB' },
              { title: 'Service C', value: 'serviceC' },
              { title: 'Service D', value: 'serviceD' },
              { title: 'Service E', value: 'serviceE' },
            ],
